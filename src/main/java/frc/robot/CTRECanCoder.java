...
public class CTRECanCoder extends WPI_CANCoder {
    ...
    public double getPosTstmp() { return this.getLastTimestamp(); }
    public double getAbsValue() { return this.getAbsolutePosition(); }
    public String getAbsUnits() { return this.getLastUnitString(); }
    public double getAbsTstmp() { return this.getLastTimestamp(); }
    public double getVelValue() { return this.getVelocity(); }
    public String getVelUnits() { return this.getLastUnitString(); }
    public double getVelTstmp() { return this.getLastTimestamp(); }
    public double getBatValue() { return this.getBusVoltage(); }
    public String getBatUnits() { return this.getLastUnitString(); }
    public double getBatTstmp() { return this.getLastTimestamp(); }

    // Report miscellaneous attributes about the CANCoder
    public MagnetFieldStrength getMagnetStrength() { return this.getMagnetFieldStrength(); }
    public String getMagnetStrengthUnits() { return this.getLastUnitString(); }
    public double magnetStrengthTstmp() { return this.getLastTimestamp(); }
}
