...
public final class Constants {
    ...
    public static final class CanConstants {
        ...
        public static final double FRONT_LEFT_MODULE_STEER_OFFSET = 120;// -Math.toRadians(0.0); 231.5
        ...
        public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = 188;//-Math.toRadians(-42); 317
        ...
        public static final double BACK_LEFT_MODULE_STEER_OFFSET = 253;//-Math.toRadians(0.0);
        ...
        public static final double BACK_RIGHT_MODULE_STEER_OFFSET = 135;//-Math.toRadians(-105); 253.7
