...
public final class Constants {
    ...
    // Swerve ratios
    public static final double DRIVING_MOTOR_RATIO = 1 / ((14.0 / 50.0) * (25.0 / 19.0) * (15.0 / 45.0));
    public static final double TURNING_MOTOR_RATIO = 1 / ((14.0 / 50.0) * (10.0 / 60.0));

    public static final int[] SWERVE_OFFSETS = { 120, 188, 135, 253 };
    public static final boolean[] DRIVE_REVERSED = { false, false, true, true };
