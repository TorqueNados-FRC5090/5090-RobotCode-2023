...
public class SwerveModule extends SubsystemBase {
  ...
  public double getDriveCurrent() { return m_driveMotor.getOutputCurrent(); }

  public double getTurnVelocity() { return m_turningEncoder.getVelocity(); }
  public double getTurnPosition() { return m_turningEncoder.getPosition(); }
  public double getTurnCurrent() { return m_turningMotor.getOutputCurrent(); }
  public double getTurnAngle() { return m_turningEncoder.getPosition(); }
  ...
  public void turnMotorMove(double speed) { m_turningMotor.setVoltage(speed * RobotController.getBatteryVoltage()); }
  public void positionSMTurn(double angle) { m_turnSMController.setReference(angle, ControlType.kPosition, POS_SLOT); }
  ...
  public void driveMotorMove(double speed) { m_driveMotor.setVoltage(speed * RobotController.getBatteryVoltage()); }
  
  public boolean turnInPosition(double targetAngle) { return Math.abs(targetAngle - getTurnAngle()) < toleranceDeg; }
  public boolean turnIsStopped() { return Math.abs(m_turningEncoder.getVelocity()) < tolDegPerSec; }
